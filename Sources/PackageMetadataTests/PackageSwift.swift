...
@Suite enum PackageSwift {
    @Test static func FilesystemDependencies() throws {
        let json: String = """
        {
        ...
        """
        let expected: SPM.Manifest = .init(
            name: "swift-unidoc",
    ...
    @Test static func RepositoryDependencies() throws {
        let json: String = """
        {
            "cLanguageStandard" : null,
            "cxxLanguageStandard" : null,
    ...
    @Test static func TargetsWithLiteralDependencies() throws {
    ...
    @Test static func TargetsWithTargetDependencies() throws {
        let json: JSON.Object = try .init(parsing: """
            {
            "dependencies" : [
                {
    ...
    @Test static func TargetsWithProductDependencies() throws {
        let json: JSON.Object = try .init(parsing: """
            {
            "dependencies" : [
                {
    ...
    @Test static func IntegrationTestModules() throws {
        ...
        #expect(manifest.root.path == "\(root)")
    }
}
