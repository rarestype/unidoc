...
extension SSGC.Toolchain {
    @frozen public struct Splash {
        public let commit: SymbolGraphMetadata.Commit?
        public let triple: Symbol.Triple
        public let swift: SwiftVersion
...
extension SSGC.Toolchain.Splash {
    public init(parsing splash: String) throws {
        ...
        triple.count == 2,
        triple[0] == "Target:",
        let triple: Symbol.Triple = .init(triple[1]) else {
            throw SSGC.ToolchainError.malformedSplash
        }
